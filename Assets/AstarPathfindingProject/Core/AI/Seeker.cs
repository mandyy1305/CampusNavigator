        ...
        private void Update()
        {
            ...
            if (detailedGizmos)
            {
                ...
                if (lastCompletedNodePath != null)
                {
                    ...
                    {
                        lr.positionCount = lastCompletedNodePath.Count-1;
                        lr.SetPosition(i, (Vector3)lastCompletedNodePath[i].position);
            ...
            if (lastCompletedVectorPath != null)
            {
                ...
                {
					lr.positionCount = lastCompletedVectorPath.Count-1;
                    lr.SetPosition(i, lastCompletedVectorPath[i]);
